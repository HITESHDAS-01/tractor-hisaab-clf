    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          <div className="bg-[var(--harvest)]/10 p-5 rounded-2xl shadow-sm text-center">
          ...
          <div className="bg-[var(--rust)]/10 p-5 rounded-2xl shadow-sm text-center">
          ...
          <div className="bg-[var(--ink)]/10 p-5 rounded-2xl shadow-sm text-center">
